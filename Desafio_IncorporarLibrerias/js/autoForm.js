...
function numeroFecha() {
    ...
    cotizacionAutoPie.innerText = ('El Nº de propuesta es el: ' + numeroCotizacionRandom() + ' y será válida por 10 días a contar del '+ hoy.toLocaleDateString() + '.' + ' Gracias por Preferirnos.')  
    }
